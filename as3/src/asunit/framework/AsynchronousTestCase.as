    ...
    public class AsynchronousTestCase extends TestCase implements Test {
        ...
        protected final function ioErrorHandler(event:IOErrorEvent):void {
            ...
            if (_ioErrorExpected == false)
            {
                ...
                result.addFailure(new TestFailure(this, new IllegalOperationError(event.text)));
            }
            setRemoteDuration();
            testRemoteDuration();
        ...
        public function testRemoteDuration():void {
            ...
            {
				var error:IllegalOperationError = new IllegalOperationError("remote communication took too long: " + _remoteDuration/1000 + " seconds.\n" + this.toString());
