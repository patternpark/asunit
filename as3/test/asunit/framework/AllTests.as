package asunit.framework {
	...
	import asunit.framework.FreeRunnerExpectsErrorTest;
	...
	public class AllTests extends TestSuite {
		...
		public function AllTests() {
			...
			addTest(new asunit.framework.FreeRunnerExpectsErrorTest());
			...
			addTest(new asunit.framework.SuiteIteratorTest());
