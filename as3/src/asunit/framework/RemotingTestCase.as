package asunit.framework
{
    ...
    public class RemotingTestCase extends TestCase
    {
        ...
        */
        ...
        {
            result.addFailure(new TestFailure(this, new IllegalOperationError(event.toString())));
            isComplete = true;
        }
        ...
        */
        protected function connect ($gateway: String = null, $encoding: uint = 0): void
        {
            initConnection();
               ...
               {
                   result.addFailure(new TestFailure(this, error));
               }
        };
        ...
        */
        protected function call ($method: String = null, $responder: Responder = null, ...$arguments): void
        {
            ...
            {
                result.addFailure(new TestFailure(this, new ReferenceError("RemotingTestCase.call() has to defined a remote method.")));
            ...
            {
                result.addFailure(new TestFailure(this, new ReferenceError("RemotingTestCase.call() has to defined a responder to handling its results.")));
                hasReferenceError = true;
            }
